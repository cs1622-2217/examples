...
// &[Token] is to Vec<Token> as &str is to String.
// &[Token] is a slice type, meaning this function can accept any type which can be
// sliced (including Vecs and arrays).
fn parse_it(tokens: &[Token]) {
	show_tokens(&tokens);
